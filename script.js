...
const WeekdayTitle = () =>
    React.createElement("div", { className: "weekdayTitleContainer" },
        ...
        React.createElement("div", { className: "weekWrap" }, "Thu"),
    ...
    render() {
        ...
        const renderCalendar = dayIsClicked => {
            currentMonthArr.map(item => {
                ...
                arr.push(
                    React.createElement("div", { key: item.key, className: item.className, onClick: () => { this.handleDayClick(item.key); }, onTouch: () => { this.handleDayClick(item.key); } }, React.createElement("span", { className: style }, item.dayNum))
                );
            });
